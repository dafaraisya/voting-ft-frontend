...
export default {
  ...
  methods: {
    ...
    del(id) {
      axios
        .delete("http://52.170.214.236:3000/api/v1/participant/" + id)
    ...
    search() {
      ...
      axios
        .get(
          "http://52.170.214.236:3000/api/v1/participant/search/" +
            this.keyword
        )
        .then((res) => {
  ...
  mounted() {
    axios
      .get(
        "http://52.170.214.236:3000/api/v1/participant/page/" +
